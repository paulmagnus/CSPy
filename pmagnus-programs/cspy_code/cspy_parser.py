...
# NO GENERICS IN CSPy
# def p_opt_generic(p):
#     '''opt_generic : empty empty'''
#     p[0] = p[2]
# def p_opt_generic(p):
#     '''opt_generic : LT genericlist GT
#                    | empty empty'''
#     p[0] = p[2]

# def p_genericlist_single(p):
#     '''genericlist : IDENTIFIER EXTENDS type'''
#     p[0] = ast(p, "GENERICLIST_SINGLE", 1, 3)

# def p_genericlist_multi(p):
#     '''genericlist : genericlist COMMA genericlist'''
#     p[0] = ast(p, "GENERICLIST_MULTI", 1, 3)
...
# def p_generic_type(p): # do we need this? I don't see it used anywhere
#     '''generic_type : IDENTIFIER LT nonempty_typelist GT'''
#     p[0] = ast(p, "GENERIC_TYPE", 1, 3)
...
def p_class_definition_error(p):
    ''' class_definition : CLASS IDENTIFIER opt_generic opt_extends error NL INDENT class_suite DEDENT
                         | CLASS IDENTIFIER opt_generic opt_extends COLON NL INDENT error DEDENT'''
    print >> sys.stderr, "Class definition invalid syntax.\n"

def p_opt_generic_error(p):
    '''opt_generic : LT error GT'''
    print >> sys.stderr, "Error in generic list expression.\n" # Make a better error message
...
# def p_genertic_type_error(p):
#     '''generic_type : IDENTIFIER LT error GT'''
#     print("Type list invalid syntax.\n")
